...
public class Role {
    ...
    public boolean equals(Object o) {
        ...
        if (action != null ? !action.equals(role.action) : role.action != null) return false;
        if (createtime != null ? !createtime.equals(role.createtime) : role.createtime != null) return false;
        if (createusercompany != null ? !createusercompany.equals(role.createusercompany) : role.createusercompany != null)
            return false;
        if (createuserid != null ? !createuserid.equals(role.createuserid) : role.createuserid != null) return false;
        if (createusermobile != null ? !createusermobile.equals(role.createusermobile) : role.createusermobile != null)
            return false;
        if (createusername != null ? !createusername.equals(role.createusername) : role.createusername != null)
            return false;
